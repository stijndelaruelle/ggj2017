...
public class ParseText : MonoBehaviour
{
	...
	public static string Shuffle(string source)
	{
		...
		{
			char randomChar = sourceChars[UnityEngine.Random.Range(0, sourceChars.Count)];
			sourceChars.Remove(randomChar);

			shuffledString = shuffledString + randomChar.ToString();
		}
